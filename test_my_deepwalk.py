...
from pt_model.test_negative_loss import NEG_loss
import sys
...
if __name__ == "__main__":
    ...
    neg_loss = Context2Vec(model, negative)
    ...
    for batch in emb_utils.chunkize_serial(
            ...
            True):
        input, output = batch
        loss = neg_loss.forward(input, output, negative_sampling_fn=model.negative_sample)
    ...
    io_utils.save(word_embeddings, "pytorch_embedding_my", path="../data")