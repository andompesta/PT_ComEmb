...
if __name__ == "__main__":
    ...
    o3_loss = Community2Emb(model, reg_covar=0.00001, f_type=CudaFloatTensor)
    ...
    examples_files = [exmple_filebase + ".{}".format(i) for i in range(num_workers)]
    ...
    # pre-training phase
    learn_second(o2_loss, lr, model, examples_files, total_example=total_example, alpha=alpha, batch_size=batch_size*100)
    learn_first(o1_loss, lr, model, edges, num_iter=num_iter, batch_size=batch_size)
    ...
    for it in range(1):
        o3_loss.fit(model)
        learn_first(o1_loss, lr, model, edges,
